...
namespace dbgl
{
	...
	public:
	     ...
	     */
	    virtual void setUniformFloat(UniformHandle handle, const float value) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformFloat2(UniformHandle handle, const float value[2]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformFloat3(UniformHandle handle, const float value[3]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformFloat4(UniformHandle handle, const float value[4]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformInt(UniformHandle handle, const int value) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformInt2(UniformHandle handle, const int value[2]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformInt3(UniformHandle handle, const int value[3]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformInt4(UniformHandle handle, const int value[4]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformBool(UniformHandle handle, const bool value) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformBool2(UniformHandle handle, const bool value[2]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformBool3(UniformHandle handle, const bool value[3]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     * @param value New value
	     */
	    virtual void setUniformBool4(UniformHandle handle, const bool value[4]) const = 0;
	    /**
	     * @brief Sets a uniform by it's handle
	     * @param handle Uniform handle
	     ...
	     * @param value New value
	     */
	    virtual void setUniformSampler(UniformHandle handle, const int value) const = 0;
    };
}
