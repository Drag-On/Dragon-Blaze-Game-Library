...
namespace dbgl
{
	...
	public:
		 ...
		 */
		virtual IconifiedEventType::DelegatePtr addIconifiedCallback(IconifiedCallbackType const& callback) = 0;
		/**
		 ...
		 * @param callback Function to be called when this window's framebuffer needs a resize
		 */
		virtual bool removeFramebufferResizeCallback(FramebufferResizeEventType::DelegatePtr const& callback) = 0;
		/**
		 ...
		 */
		virtual PositionEventType::DelegatePtr addPositionCallback(PositionCallbackType const& callback) = 0;
		/**
		 ...
		 */
		virtual CursorEnterEventType::DelegatePtr addCursorEnterCallback(CursorEnterCallbackType const& callback) = 0;
		/**
		 ...
		 */
		virtual MouseButtonEventType::DelegatePtr addMouseButtonCallback(MouseButtonCallbackType const& callback) = 0;
		/**
