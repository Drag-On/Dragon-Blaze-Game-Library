...
namespace dbgl
{
    ...
    void RenderContextGL33::readPixels(int x, int y, int width, int height, ITexture::PixelFormat format,
	...
	glReadPixels(x, y, width, height, TextureGL33::pixelFormat2GL(format),
		TextureGL33::pixelType2GL(type), buf);
    }
