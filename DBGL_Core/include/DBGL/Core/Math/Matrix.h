...
namespace dbgl
{
    ...
    public:
        ...
        Matrix(Matrix<T, N2, M2> const& other);
        /**
        ...
        /**
         * @brief Returns the sub matrix up to a specified column and row
         * @returns The sub matrix
         * @note: This does not check for valid dimensions
         */
        template<unsigned int A, unsigned int B>
        Matrix<T, A, B> getSubMatrix() const;
        /**
         * @brief Returns the sub matrix from column A and row B up to column C and row D
         * @returns The sub matrix
         * @note: This does not check for valid dimensions
         */
        template<unsigned int A, unsigned int B, unsigned int C, unsigned int D>
        Matrix<T, C + 1 - A, D + 1 - B> getSubMatrix() const;
        /**
        ...
        const Matrix<T, M, O> operator*(Matrix<T, O, N> const& rhs) const;
        /**
