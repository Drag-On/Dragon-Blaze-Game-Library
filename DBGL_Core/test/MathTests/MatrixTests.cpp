...
template<class Mat> void testConstructor()
{
	Mat mat;
...
template<class Mat> void testTranspose()
{
	Mat mat;
...
template<class Mat> void testInvert()
{
	Mat mat;
...
template<class Mat> void testIsZero()
{
	Mat mat;
	ASSERT(!mat.isZero());
	Mat mat2(0.0);
...
template<class Mat> void testIsIdentity()
{
	Mat mat;
	ASSERT(mat.isIdentity());
	Mat mat2(0.0);
...
template<class Mat> void testGetDataPointer()
{
	Mat mat;
...
template<class Mat> void testOperatorAssign()
{
	Mat mat;
	Mat mat2(42.0);
	mat = mat2;
...
template<class Mat> void testOperatorPlusMinus()
{
	Mat mat;
	Mat mat2(42.0);
	Mat mat3 = mat + mat2;
...
template<class Mat> void testOperatorMultiplyDivide()
{
	Mat mat;
	Mat mat2(42.0);
	Mat mat3 = mat * mat2;
...
template<class Mat> void testOperatorUnaryMinus()
{
	Mat mat(42.0);
	Mat mat2 = -mat;
...
template<class Mat> void testOperatorEquality()
{
	Mat mat(42.0);
	Mat mat2(42.0);
	ASSERT(mat == mat2);
